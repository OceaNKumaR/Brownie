...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#6F3917")
      ...
      switch (reaction.emoji.name) {
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            const pausemebed = new MessageEmbed().setColor("#6F3917")
            ...
            const playembed = new MessageEmbed().setColor("#6F3917")
        ...
        case "🔄":
          ...
          const loopembed = new MessageEmbed().setColor("#6F3917")
        ...
        case "⏹":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#6F3917").setAuthor(`${user.username} stopped the music!`, "https://cdn.discordapp.com/emojis/769915194066862080.png")
