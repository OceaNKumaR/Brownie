...
client.on(`message`, async (message) => {
  ...
  if(message.content.includes(client.user.id)) {
    message.reply(new Discord.MessageEmbed().setColor("#6F3917").setAuthor(`${message.author.username}, My Prefix is ${PREFIX}, to get started; type ${PREFIX}help`, message.author.displayAvatarURL({dynamic:true})));
  } 
 ...
 if (timestamps.has(message.author.id)) {
   ...
   if (now < expirationTime) {
     ...
     return message.reply(
      new MessageEmbed().setColor("#6F3917")
